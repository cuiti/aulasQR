var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		...
		this.imgButton = new AR.ImageResource("assets/BotonPostgrado.jpg");

		var imgOne = new AR.ImageResource("assets/world.png");
		var overlayOne = new AR.ImageDrawable(imgOne, 1, {
			offsetX: -0.15,
			offsetY: 0
		});

		var pageOneButton = this.createWwwButton("http://postgrado.info.unlp.edu.ar/", 0.4, {
    		offsetX: -0.25,
    		offsetY: -0.25
		});
